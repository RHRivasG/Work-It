...
public struct User
{
    ...
    public User(string userRole, string username, string password, string[] preferences, Guid? id = null) : this(userRole.ToRole(), username.AsMemory(), password.AsMemory(), preferences, id)
    {
    }
